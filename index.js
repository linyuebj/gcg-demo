...
var APP_SECRET = "Qb6jWnh-b5jTuYqpLmY4DVCwUupL";
...
function afDetails(conversationId, targetUserId, targetDialogId, spaceId, files) {
  ...
  var afgraphql1 = "mutation {createTargetedMessage(input: {conversationId: \"" + conversationId + "\" targetUserId: \"" + targetUserId + "\" targetDialogId: \"" + targetDialogId + "\" annotations: [{genericAnnotation: {title: \""+assetName+"\" text: \"" + text + "\" buttons: [{postbackButton: {title: \"发送到空间\", id: \"SHARE-"+ assetId + "\", style: PRIMARY}}";
  var afgraphql2 = "]}}]}){successful}}";
